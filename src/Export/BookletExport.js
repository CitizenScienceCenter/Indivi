...
class BookletExport extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount() {
        ...
        const downloads = <BookletGeneration data_noH={data_noH} headers={headers} 
    ...
    render() {
        return (
            ...
            <Grid>
                <Row>
                <Jumbotron>
                    <h2>Export individualized Booklets as PDF</h2>
                    <p>
                        Here you can download a Booklet (in PDF-Format) with the individualized feedback of each 
                    ...
                    <p>Dowload all the Booklets at once:</p>
                    <p> <Button
                        bsStyle="primary" 
                ...
                <Row>
                    <Panel>
                        <Panel.Heading>Alternatively, you can download each Booklet separately.</Panel.Heading>
                        <Panel.Body>
